defmodule Zappa.Sendgrid.BlockHelpers.NotEquals do
  @moduledoc """
  https://www.twilio.com/docs/sendgrid/for-developers/sending-email/using-handlebars#notequals
  """
  ...
  def parse(%Tag{raw_options: ""}) do
    {:error, "The notEquals block helper requires two options, e.g. {{#notEquals var1 var2}}"}
  end
