defmodule Zappa.Sendgrid.BlockHelpers.LessThan do
  @moduledoc """
  https://www.twilio.com/docs/sendgrid/for-developers/sending-email/using-handlebars#lessthan
  """
  alias Zappa.Tag
  import Zappa.Sendgrid.Variable, only: [from_options_arg: 1]

  def parse(%Tag{raw_options: ""}) do
    {:error, "The lessThan block helper requires two options, e.g. {{#lessThan var1 var2}}"}
  end
